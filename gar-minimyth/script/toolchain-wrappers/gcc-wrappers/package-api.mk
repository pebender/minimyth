...
install-wrappers:
	...
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-cpp $(build_DESTDIR)$(build_bindir)/wrapper/$(GARHOST)-cpp
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-gcc $(build_DESTDIR)$(build_bindir)/wrapper/$(GARHOST)-gcc
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-g++ $(build_DESTDIR)$(build_bindir)/wrapper/$(GARHOST)-g++
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-ld.bfd $(build_DESTDIR)$(build_bindir)/wrapper/$(GARHOST)-ld.bfd
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-ld.bfd $(build_DESTDIR)$(build_bindir)/wrapper/$(GARHOST)-ld
