...
install-wrappers:
	...
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-clang $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-clang
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-clang++ $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-clang++
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-clang-cpp $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-clang-cpp
	@install -v --mode=0755 $(WORKSRC)/$(GARHOST)-ld.lld $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-ld.lld
	@ln -sfv ../ccache $(build_DESTDIR)$(build_bindir)/ccache.d/$(GARHOST)-clang
	@ln -sfv ../ccache $(build_DESTDIR)$(build_bindir)/ccache.d/$(GARHOST)-clang++
	@ln -sfv ../llvm-objdump $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-llvm-objdump
	@ln -sfv ../llvm-objcopy $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-llvm-objcopy
	@ln -sfv ../llvm-strip $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-llvm-strip
	@ln -sfv ../llvm-ranlib $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-llvm-ranlib
	@ln -sfv ../llvm-readelf $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-llvm-readelf
	@ln -sfv ../llvm-nm $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-llvm-nm
	@ln -sfv ../llvm-as $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-llvm-as
	@ln -sfv ../llvm-ar $(build_DESTDIR)$(build_bindir)/wrapper.d/$(GARHOST)-llvm-ar
	@$(MAKECOOKIE)
